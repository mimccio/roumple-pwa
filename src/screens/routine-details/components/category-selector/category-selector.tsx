// TODO: move to "common" to replace old
      ...
      <Listbox disabled={isLoading || isError} value={category} onChange={onSelect}>
        {({ open }) => (
          <div className="relative">
            ...
            >
              <Listbox.Options className="absolute left-1 right-1 z-10 mt-1 max-h-60  max-w-lg overflow-auto rounded-md bg-gray-50 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
