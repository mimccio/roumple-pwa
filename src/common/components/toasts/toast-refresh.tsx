...
export function ToastRefresh({ t, onUpdate }: Props) {
  const onRefresh = () => {
    onUpdate()
    toast.dismiss(t.id)
  }
        ...
        <div className="pointer-events-auto flex w-full max-w-md  rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
          ...
          <div className="flex w-0 flex-1 items-center p-4">
            <div className="w-full">
              <p className="text-sm font-semibold text-gray-600">Need to refresh</p>
              <p className="mt-1 text-sm text-gray-500">A new version is available.</p>
            </div>
          </div>
