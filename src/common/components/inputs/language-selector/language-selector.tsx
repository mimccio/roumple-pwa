...
export function LanguageSelector() {
  ...
  return (
    <div className="flex w-full max-w-lg flex-wrap items-center justify-between gap-x-8 gap-y-2">
      <Listbox value={language} onChange={handleSelectLanguage}>
        <Listbox.Label>{t('Select language')}</Listbox.Label>

        <div className="flex max-w-xs flex-grow">
          <div className="relative mr-4 w-full sm:mr-8">
